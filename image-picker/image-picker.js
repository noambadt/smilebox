...
(function() {
  ...
  sanitized_options = function(opts) {
    ...
    return jQuery_1_6_4.extend(default_options, opts);
  };

  both_array_are_equal = function(a, b) {
    return jQuery_1_6_4(a).not(b).length === 0 && jQuery_1_6_4(b).not(a).length === 0;
  };
  ...
  ImagePicker = (function() {
    ...
    function ImagePicker(select_element, opts) {
      ...
      this.select = jQuery_1_6_4(select_element);
    ...
    ImagePicker.prototype.create_picker = function() {
      this.picker = jQuery_1_6_4("<ul class='thumbnails image_picker_selector'></ul>");
      this.picker_options = [];
    ...
    ImagePicker.prototype.recursively_parse_option_groups = function(scoped_dom, target_container) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        option_group = jQuery_1_6_4(option_group);
        container = jQuery_1_6_4("<ul></ul>");
        container.append(jQuery_1_6_4("<li class='group_title'>" + (option_group.attr("label")) + "</li>"));
        target_container.append(jQuery_1_6_4("<li>").append(container));
    ...
    ImagePicker.prototype.toggle = function(imagepicker_option) {
      ...
      if (this.multiple) {
        if (__indexOf.call(this.selected_values(), selected_value) >= 0) {
          ...
          new_values.splice(jQuery_1_6_4.inArray(selected_value, old_values), 1);
          this.select.val([]);
  ...
  ImagePickerOption = (function() {
    ...
    function ImagePickerOption(option_element, picker, opts) {
      ...
      this.option = jQuery_1_6_4(option_element);
      this.create_node();
    }
    ...
    ImagePickerOption.prototype.is_selected = function() {
      ...
      if (this.picker.multiple) {
        return jQuery_1_6_4.inArray(this.value(), select_value) >= 0;
      } else {
    ...
    ImagePickerOption.prototype.create_node = function() {
      var image, thumbnail;
      this.node = jQuery_1_6_4("<li/>");
      image = jQuery_1_6_4("<img class='image_picker_image'/>");
      image.attr("src", this.option.data("img-src"));
      thumbnail = jQuery_1_6_4("<div class='thumbnail'>");
      thumbnail.click({
        option: this
      }, function(event) {
      ...
      if (this.opts.show_label) {
        thumbnail.append(jQuery_1_6_4("<p/>").html(this.label()));
      }
